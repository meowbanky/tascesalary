...
<div class="container mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-2">
            <div class="p-4 bg-gray-200 dark:bg-gray-600 rounded-t-lg">
        ...
        <div class="md:col-span-1 space-y-4">
            ...
            <button class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 focus:outline-none w-full" id="suspension" >Halve Allowance</button>
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all sm:w-full sm:max-w-lg">
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            ...
            <form>
                ...
                <input type="hidden" id="dept_id" name="dept_id" value="<?php echo $employeeDetails['DEPTCD'] ?>">
...
<div id="modal_suspension" class="closemodal fixed inset-0 flex items-center justify-center z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="scrollable-content bg-white rounded-lg shadow-lg overflow-y-scroll transform transition-all sm:w-full sm:max-w-lg max-h-screen flex flex-col">
        <div class="bg-blue-600 px-4 py-3">
            <h3 class="text-lg font-semibold text-white text-center" id="modal-title">HALVE ALLOWANCES FOR <br><?php echo $employeeDetails['NAME'] ?></h3>
        </div>
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 overflow-y-auto flex-1">
            <div class="grid grid-cols-1 gap-4">
                <!-- Hidden Fields -->
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all sm:w-full sm:max-w-lg max-h-screen flex flex-col">
        ...
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 overflow-y-auto flex-1">
            <div class="grid grid-cols-1 gap-4">
                ...
                <input type="hidden" id="step" name="step" value="<?php echo $employeeDetails['STEP']?>">
                <input type="hidden" id="salarytype" name="salarytype" value="<?php echo $employeeDetails['SALARY_TYPE']?>">
                <input type="hidden" id="email" name="email" value="<?php echo $employeeDetails['EMAIL'] ?>">
