...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="container mx-auto py-8">
        <div class="flex justify-between">
            <h1 class="text-2xl font-bold mb-6">Payroll Summary</h1>
            <div>
        ...
        <div class="container mx-auto p-4">
            <div class="bg-white shadow rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    <!-- Left: Logo + Business Name + Payroll Summary (stacked vertically) -->
...
<script>
    $(document).ready(function() {
        ...
        $('#submit').click(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'libs/get_report_summary.php',
        ...
        $('#download-excel-button').click(function() {
            ...
            var period = $('#pay_period').val();
            var email = $('#email').val();
            window.location.href = 'libs/generate_excel_payrollsummary.php?period=' + period + (email ? '&email=' + encodeURIComponent(email) : '');
        });
        ...
        $('#export-pdf-button').click(function() {
            ...
            var period = $('#pay_period').val();
            var email = $('#email').val();
            window.location.href = 'libs/generate_pdf_payrollsummary.php?period=' + period + (email ? '&email=' + encodeURIComponent(email) : '');
        });
    });
</script>
