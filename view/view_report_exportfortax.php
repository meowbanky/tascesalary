...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="container mx-auto py-8">
        ...
        <h1 class="text-2xl font-bold mb-6">Export for Tax</h1>
            <div>
    ...
    <script>
        ...
        function setModalMaxHeight() {
            ...
            $('#download-excel-button').click(function() {
                ...
                window.location.href = 'libs/getexporttax.php?payperiod='+period;
            });
            ...
            $('#submit').click(function(event) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'libs/getexporttax.php?payperiod',
                    data: {
                        payperiod: $('#pay_period').val()
                    },
                    success: function(response) {
                        window.location.href = 'libs/' + response;
                    },
