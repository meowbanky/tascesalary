...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="container mx-auto py-8">
        <div class="flex justify-between">
            <h1 class="text-2xl font-bold mb-6">Bank Summary</h1>
            <div>
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <h2 class="text-lg font-semibold">BANK SUMMARY</h2>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#submit').click(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'libs/get_report_banksummary.php',
                data: { payperiod: $('#pay_period').val() },
                ...
                error: function(xhr, status, error) {
                    ...
                    alert('An error occurred while loading the bank summary. Please try again.');
                    $backdrop.hide();
                }
            });
        });
        ...
        $('#download-excel-button').click(function() {
            ...
            var period = $('#pay_period').val();
            var email = $('#email').val();
            window.location.href = 'libs/generate_excel_banksummary.php?period=' + period + (email ? '&email=' + encodeURIComponent(email) : '');
        });
        ...
        $('#export-pdf-button').click(function() {
            ...
            var period = $('#pay_period').val();
            var email = $('#email').val();
            window.location.href = 'libs/generate_pdf_banksummary.php?period=' + period + (email ? '&email=' + encodeURIComponent(email) : '');
        });
    });
</script>
