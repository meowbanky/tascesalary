...
<div class="overflow-x-auto pr-4 mx-auto">
    <table id="table-search" class="min-w-full bg-white">
        ...
        <tr class="w-full bg-gray-200">
            ...
            <th class="sortable sm:text-xs px-4 py-2 text-left text-sm font-medium text-gray-700">TIN</th>
        ...
        <?php $gross=0; $deduct=0;$sn= 1; if($GrossPays){ foreach($GrossPays as $GrossPay){ ?>
            <tr>
                ...
                <td class="border px-4 py-2"><?php echo $GrossPay['TIN']; ?></td>
        ...
        <tr>
            <td class="border px-4 py-2 font-bold" colspan="9">Total</td>
