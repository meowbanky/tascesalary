    ...
    <div id="payslipModal" class="closemodal fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
        <div class="modal-content rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl w-full flex flex-col bg-white">
            ...
            <!-- Scrollable Content -->
                ...
                <div class="flex justify-between mb-2">
                    <span class="font-semibold">Staff No.:</span> <span><?php echo $employeePayslip['OGNO'] ?></span>
                </div>
                <div class="flex justify-between mb-2">
                ...
                <div class="flex justify-between mb-2">
                    <span class="font-semibold">SALARY TYPE:</span> <span><?php echo $employeePayslip['SalaryType']; ?></span>
                </div>
                <div class="mt-4">
