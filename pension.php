...
<script>
    $(document).ready(function() {
        ...
        $('#loadContent').load('view/view_pensions.php');
        $("#search").focus();
        $("#search").select();
        $("#search").autocomplete({
            source: 'libs/searchbank.php',
            type: 'POST',
            delay: 10,
            autoFocus: false,
            minLength: 3,
            select: function (event, ui) {
                ...
                $('#searchform').ajaxSubmit({
                    url: 'view/view_banks.php', // URL for form submission
                    type: 'POST', // Method for form submission
                    data:{staff_id:ui.item.value},
